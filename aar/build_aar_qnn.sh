...
mkdir -p $SCRIPT_DIR/../build-android-aar-qnn
cd $SCRIPT_DIR/../build-android-aar-qnn
cmake -DANDROID_ABI=arm64-v8a -DANDROID_PLATFORM=android-24 -DANDROID_NDK=$ANDROID_NDK -DCMAKE_TOOLCHAIN_FILE=$ANDROID_NDK/build/cmake/android.toolchain.cmake -GNinja -DFR_ENABLE_QNN=ON -DCMAKE_EXPORT_COMPILE_COMMANDS=ON -DCMAKE_BUILD_TYPE=Release ..
ninja
